...
exports.createGroup = (request, response) => {
    ...
    db.collection('groups')
        .add(group)
        .then(groupRef => {
        const member = Object.assign({ 'groupId': groupRef.id }, user);
...
exports.userGroups = (request, response) => {
    response.setHeader('access-control-allow-origin', '*');
...
exports.groupMembers = (request, response) => {
    response.setHeader('access-control-allow-origin', '*');
...
exports.isGroupAdmin = (request, response) => {
    response.setHeader('access-control-allow-origin', '*');
    const groupId = request.query.gid;
    const userId = request.query.uid;
    db.collection('members')
